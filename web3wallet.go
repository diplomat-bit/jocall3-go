...
func (r *Web3WalletService) GetBalances(ctx context.Context, walletID string, opts ...option.RequestOption) (res *Web3WalletGetBalancesResponse, err error) {
	opts = slices.Concat(r.Options, opts)
	if walletID == "" {
...
type Web3WalletGetBalancesResponse struct {
	Balances []Web3WalletGetBalancesResponseBalance `json:"balances"`
...
type Web3WalletGetBalancesResponseBalance struct {
	Amount string                                   `json:"amount"`
	Symbol string                                   `json:"symbol"`
	JSON   web3WalletGetBalancesResponseBalanceJSON `json:"-"`
}

// web3WalletGetBalancesResponseBalanceJSON contains the JSON metadata for the
// struct [Web3WalletGetBalancesResponseBalance]
type web3WalletGetBalancesResponseBalanceJSON struct {
...
func (r *Web3WalletGetBalancesResponseBalance) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r web3WalletGetBalancesResponseBalanceJSON) RawJSON() string {
	return r.raw
}
