...
func TestAIAdvisorGetHistoryWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AI.Advisor.GetHistory(context.TODO(), githubcomjocall3go.AIAdvisorGetHistoryParams{
