...
func (r *AIAdService) GetOperationStatus(ctx context.Context, operationID string, opts ...option.RequestOption) (res *AIAdGetOperationStatusResponse, err error) {
	opts = slices.Concat(r.Options, opts)
	if operationID == "" {
...
type AIAdGetOperationStatusResponse struct {
	Progress int64                              `json:"progress"`
	Status   string                             `json:"status"`
	VideoUri string                             `json:"videoUri"`
	JSON     aiAdGetOperationStatusResponseJSON `json:"-"`
}

// aiAdGetOperationStatusResponseJSON contains the JSON metadata for the struct
// [AIAdGetOperationStatusResponse]
type aiAdGetOperationStatusResponseJSON struct {
...
func (r *AIAdGetOperationStatusResponse) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r aiAdGetOperationStatusResponseJSON) RawJSON() string {
	return r.raw
}
