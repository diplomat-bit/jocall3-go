...
func TestUserMeBiometricDelete(t *testing.T) {
	...
	err := client.Users.Me.Biometrics.Delete(context.TODO())
	if err != nil {
...
func TestUserMeBiometricEnroll(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	err := client.Users.Me.Biometrics.Enroll(context.TODO(), githubcomjocall3go.UserMeBiometricEnrollParams{
		BiometricType: githubcomjocall3go.F(githubcomjocall3go.UserMeBiometricEnrollParamsBiometricTypeFingerprint),
...
func TestUserMeBiometricVerify(t *testing.T) {
	...
	_, err := client.Users.Me.Biometrics.Verify(context.TODO(), githubcomjocall3go.UserMeBiometricVerifyParams{
		BiometricSignature: githubcomjocall3go.F("biometricSignature"),
	})
	if err != nil {
		var apierr *githubcomjocall3go.Error
		if errors.As(err, &apierr) {
