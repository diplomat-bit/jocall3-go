...
func TestAIIncubatorListPitches(t *testing.T) {
	...
	_, err := client.AI.Incubator.ListPitches(context.TODO())
	if err != nil {
...
func TestAIIncubatorSubmitPitch(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.AI.Incubator.SubmitPitch(context.TODO(), githubcomjocall3go.AIIncubatorSubmitPitchParams{
