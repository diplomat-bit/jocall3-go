...
func (r *SystemNotificationService) Send(ctx context.Context, body SystemNotificationSendParams, opts ...option.RequestOption) (err error) {
	opts = slices.Concat(r.Options, opts)
...
type SystemNotificationListTemplatesResponse struct {
	...
	Channel SystemNotificationListTemplatesResponseChannel `json:"channel,required"`
...
type SystemNotificationListTemplatesResponseChannel string

const (
	SystemNotificationListTemplatesResponseChannelEmail SystemNotificationListTemplatesResponseChannel = "email"
	SystemNotificationListTemplatesResponseChannelPush  SystemNotificationListTemplatesResponseChannel = "push"
	SystemNotificationListTemplatesResponseChannelSMS   SystemNotificationListTemplatesResponseChannel = "sms"
)

func (r SystemNotificationListTemplatesResponseChannel) IsKnown() bool {
	switch r {
	case SystemNotificationListTemplatesResponseChannelEmail, SystemNotificationListTemplatesResponseChannelPush, SystemNotificationListTemplatesResponseChannelSMS:
		return true
	}
	return false
}

type SystemNotificationSendParams struct {
...
func (r SystemNotificationSendParams) MarshalJSON() (data []byte, err error) {
